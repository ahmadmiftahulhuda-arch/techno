      ...
      <header class="hq-topbar">
        ...
        <div class="hq-topbar-right">
          ...
          <div class="hq-user-profile" title="Klik untuk Edit Profil Manajer" onclick="openEditProfileModal()">
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&q=80" alt="Avatar Pengguna" class="hq-avatar-img" id="topbarAvatarImg" loading="lazy">
          </div>
        ...
        <div class="container hero-grid">
          ...
          <div class="hero-visual-stage">
            <div class="hero-image-card-bg">
              <img src="images/combo.png" alt="Es Jeruk dan Salad Sruput & Nyam" class="hero-img-showcase" loading="lazy">
            </div>
          </div>
        </div>
      </section>
