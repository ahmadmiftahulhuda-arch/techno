...
<body>
      ...
      <div class="container hero-grid">
        ...
        <div class="hero-visual-stage">
          <div class="hero-image-card-bg">
            <img src="images/combo.png" alt="Es Jeruk dan Salad Sruput &amp; Nyam" class="hero-img-showcase" fetchpriority="high" loading="eager">
      ...
      <div class="container">
        <div class="combo-banner-card">
          ...
          <div class="combo-banner-img">
            <img src="images/combo.png" alt="Paket Combo Highlight" loading="lazy">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="reviews-masonry-grid" id="userReviewsContainer">
          ...
          <div class="user-review-card">
            ...
            <div class="review-photo-wrapper">
              <img src="images/review_dish.png" alt="Foto Ulasan Pelanggan" class="review-photo-img" loading="lazy">
            </div>
          </div>
  ...
  <div class="mobile-sticky-cart-bar" id="mobileStickyCartBar" onclick="openCartDrawer()">
    ...
    <button class="btn-mobile-checkout">
      Lihat <i class="fa-solid fa-chevron-right"></i>
    </button>
  </div>
  ...
  <div class="admin-drawer" id="adminDrawer">
    <div class="admin-header">
      <h3 style="font-size: 1.1rem; color: var(--primary-emerald);"><i class="fa-solid fa-kitchen-set"></i> Dashboard Dapur</h3>
      <button class="btn-close-modal" id="closeAdminBtn"><i class="fa-solid fa-xmark"></i></button>
    </div>
    <div class="admin-body">
      <h4 style="font-size: 0.95rem; margin-bottom: 1rem; color: var(--text-main);">Daftar Pesanan Masuk (Real-time)</h4>
